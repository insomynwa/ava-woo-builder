...
?>
<li class="ava-woo-products-list__item ava-woo-builder-product" data-product-id="<?php echo $product_id ?>">
	<div class="ava-woo-products-list__inner-box">
		<div class="ava-woo-products-list__item-img"><?php  include $this->get_template( 'item-thumb' ); ?></div>
	 <div class="ava-woo-products-list__item-content"><?php
