...
if ( ! class_exists( 'Ava_Woo_Builder_Macros' ) ) {

	/**
	 * Define Ava_Woo_Builder_Macros class
	 */
	class Ava_Woo_Builder_Macros {
		...
		public function get_all() {
			return apply_filters( 'ava-woo-builder/macros/macros-list', array(
