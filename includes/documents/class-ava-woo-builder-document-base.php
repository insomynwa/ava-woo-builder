...
class Ava_Woo_Builder_Document_Base extends Elementor\Core\Base\Document {
	...
	public function get_name() {
		return 'ava-woo-builder-archive-document';
	}
	...
	public function save_template_item_to_meta( $post_id ) {
		...
		update_post_meta( $post_id, '_ava_woo_builder_content', $content );
	...
	public function get_elements_raw_data( $data = null, $with_html_content = false ) {
		ava_woo_builder()->documents->switch_to_preview_query();

		$editor_data = parent::get_elements_raw_data( $data, $with_html_content );

		ava_woo_builder()->documents->restore_current_query();
	...
	public function get_elements_data( $status = 'publish' ) {
		...
		if ( ! isset( $_GET[ ava_woo_builder_post_type()->slug() ] ) || ! isset( $_GET['preview'] ) ) {
