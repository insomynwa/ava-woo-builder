<?php
/**
 * Class: Ava_Woo_Builder_Products_Page_Title
 * Name: Page Title
 * Slug: ava-woo-builder-products-page-title
 */
...
class Ava_Woo_Builder_Products_Page_Title extends Ava_Woo_Builder_Base {

	public function get_name() {
		return 'ava-woo-builder-products-page-title';
	}

	public function get_title() {
		return esc_html__( 'Products Page Title', 'ava-woo-builder' );
	}

	public function get_icon() {
		return 'avawoobuilder-icon-32';
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			'ava-woo-builder/products-page-title/css-scheme',
			array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Page Title', 'ava-woo-builder' ),
