<?php
/**
 * Class: Ava_Woo_Builder_Products_Loop
 * Name: Products Loop
 * Slug: ava-woo-builder-products-loop
 */
...
class Ava_Woo_Builder_Products_Loop extends Ava_Woo_Builder_Base {

	public function get_name() {
		return 'ava-woo-builder-products-loop';
	}

	public function get_title() {
		return esc_html__( 'Products Loop', 'ava-woo-builder' );
	}

	public function get_icon() {
		return 'avawoobuilder-icon-27';
	}
