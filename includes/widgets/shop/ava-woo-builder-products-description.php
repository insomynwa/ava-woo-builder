<?php
/**
 * Class: Ava_Woo_Builder_Products_Description
 * Name: Products Description
 * Slug: ava-woo-builder-products-description
 */
...
class Ava_Woo_Builder_Products_Description extends Ava_Woo_Builder_Base {

	public function get_name() {
		return 'ava-woo-builder-products-description';
	}

	public function get_title() {
		return esc_html__( 'Products Description', 'ava-woo-builder' );
	}

	public function get_icon() {
		return 'avawoobuilder-icon-26';
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			...
			array(
				'term_description'    => '.elementor-ava-woo-builder-products-description .term-description',
				'archive_description' => '.elementor-ava-woo-builder-products-description .page-description',
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Products Description', 'ava-woo-builder' ),
