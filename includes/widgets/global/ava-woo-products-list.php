<?php
/**
 * Class: Ava_Woo_Products_List
 * Name: Products List
 * Slug: ava-woo-products-list
 */
...
class Ava_Woo_Products_List extends Ava_Woo_Builder_Base {
	...
	public function get_title() {
		return esc_html__( 'Products List', 'ava-woo-builder' );
	}

	public function get_icon() {
		return 'avawoobuilder-icon-17';
	}

	public function get_ava_help_url() {
		return 'https://blockcroco.com/knowledge-base/articles/avawoobuilder-products-list-widget-overview/';
	}
	...
	protected function controls_section_item( $css_scheme ) {
		...
		$this->add_control(
			...
			array(
				...
				'options'   => array(
					...
					'stretch'    => esc_html__( 'Stretch', 'ava-woo-builder' ),
				),
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				...
				'default'   => 'center',
				'options'   => array(
					'flex-start' => esc_html__( 'Left', 'ava-woo-builder' ),
					'center'     => esc_html__( 'Center', 'ava-woo-builder' ),
					'flex-end'   => esc_html__( 'Right', 'ava-woo-builder' ),
				),
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['inner-box'] => 'align-items: {{VALUE}};',
				),
		...
		$this->add_responsive_control(
			'item_space_between',
			array(
				'label'      => esc_html__( 'Space Between Items', 'ava-woo-builder' ),
				...
				'selectors'  => array(
					'{{WRAPPER}} ' . $css_scheme['item'] . ' + .ava-woo-products-list__item' => 'margin-top: {{SIZE}}{{UNIT}};',
				),
			)
		);
	...
	protected function controls_section_thumb( $css_scheme ) {
		...
		$this->add_responsive_control(
			'thumb_width',
			array(
				'label'      => esc_html__( 'Image Width', 'ava-woo-builder' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range'      => array(
					'px' => array(
