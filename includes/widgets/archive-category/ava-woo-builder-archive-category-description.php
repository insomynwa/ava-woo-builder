<?php
/**
 * Class: Ava_Woo_Builder_Archive_Category_Description
 * Name: Description
 * Slug: ava-woo-builder-archive-category-description
 */
...
class Ava_Woo_Builder_Archive_Category_Description extends Widget_Base {

	private $source = false;

	public function get_name() {
		return 'ava-woo-builder-archive-category-description';
	}

	public function get_title() {
		return esc_html__( 'Description', 'ava-woo-builder' );
	}

	public function get_icon() {
		return 'avawoobuilder-icon-35';
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			'ava-woo-builder/ava-archive-category-description/css-scheme',
			array(
				'description' => '.ava-woo-builder-archive-category-description'
			)
		);
	...
	public static function render_callback( $settings = array(), $args ) {
		...
		$description = ava_woo_builder_tools()->trim_text( $category->description, $settings['desc_length'], 'word', $settings['desc_after_text'] );

		if ( '' === $description ) {
			return false;
		}

		echo '<div class="ava-woo-builder-archive-category-description">';
		echo $description;
		echo '</div>';
