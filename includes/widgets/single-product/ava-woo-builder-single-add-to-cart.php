<?php
/**
 * Class: Ava_Woo_Builder_Single_Add_To_Cart
 * Name: Single Add to Cart
 * Slug: ava-single-add-to-cart
 */
...
class Ava_Woo_Builder_Single_Add_To_Cart extends Ava_Woo_Builder_Base {

	public function get_name() {
		return 'ava-single-add-to-cart';
	}

	public function get_title() {
		return esc_html__( 'Single Add to Cart', 'ava-woo-builder' );
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			'ava-woo-builder/ava-single-add-to-cart/css-scheme',
			array(
				'button'          => '.ava-woo-builder .single_add_to_cart_button.button',
				'qty'             => '.ava-woo-builder .qty',
				'qty_input'       => '.elementor-ava-single-add-to-cart .cart .quantity',
				'description'     => '.elementor-ava-single-add-to-cart .woocommerce-variation-description',
				'price'           => '.elementor-ava-single-add-to-cart .woocommerce-variation-price .price',
				'currency'        => '.elementor-ava-single-add-to-cart .woocommerce-Price-currencySymbol',
				'in_stock'        => '.elementor-ava-single-add-to-cart .in-stock',
				'out_stock'       => '.elementor-ava-single-add-to-cart .out-of-stock',
				'availability'    => '.elementor-ava-single-add-to-cart .stock',
				'reset_button'    => '.elementor-ava-single-add-to-cart .reset_variations',
				'variations_wrap' => '.elementor-ava-single-add-to-cart .variations',
				'select'          => '.elementor-ava-single-add-to-cart .variations select',
				'label'           => '.elementor-ava-single-add-to-cart .variations .label label'
			)
		);
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Disabled', 'ava-woo-builder' ),
			)
		);
		...
		$this->start_controls_section(
			'section_qty_style',
			array(
				'label' => esc_html__( 'Quantity Input', 'ava-woo-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			'qty_display',
			array(
				'label'     => esc_html__( 'Quantity Input Display', 'ava-woo-builder' ),
		...
		$this->add_control(
			'price_color',
			array(
				'label'     => esc_html__( 'Price Color', 'ava-woo-builder' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Currency Symbol', 'ava-woo-builder' ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Availability', 'ava-woo-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Reset Button', 'ava-woo-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Variations Select', 'ava-woo-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Variations Title', 'ava-woo-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
