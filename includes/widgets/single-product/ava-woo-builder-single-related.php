<?php
/**
 * Class: Ava_Woo_Builder_Single_Related
 * Name: Single Related Products
 * Slug: ava-single-related
 */
...
class Ava_Woo_Builder_Single_Related extends Ava_Woo_Builder_Base {

	public function get_name() {
		return 'ava-single-related';
	}

	public function get_title() {
		return esc_html__( 'Single Related Products', 'ava-woo-builder' );
	}

	public function get_icon() {
		return 'avawoobuilder-icon-9';
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			'ava-woo-builder/ava-single-related/css-scheme',
			array(
				'title' => '.ava-woo-builder > .related.products > h2'
			)
		);
