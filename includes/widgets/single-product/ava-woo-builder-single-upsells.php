<?php
/**
 * Class: Ava_Woo_Builder_Single_Upsells
 * Name: Single Upsells
 * Slug: ava-single-upsells
 */
...
class Ava_Woo_Builder_Single_Upsells extends Ava_Woo_Builder_Base {

	public function get_name() {
		return 'ava-single-upsells';
	}

	public function get_title() {
		return esc_html__( 'Single Upsells', 'ava-woo-builder' );
	}

	public function get_icon() {
		return 'avawoobuilder-icon-14';
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			'ava-woo-builder/ava-single-upsells/css-scheme',
			array(
				'title' => '.ava-woo-builder > .upsells.products > h2'
			)
		);
