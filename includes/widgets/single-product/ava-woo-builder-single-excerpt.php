<?php
/**
 * Class: Ava_Woo_Builder_Single_Excerpt
 * Name: Single Excerpt
 * Slug: ava-single-excerpt
 */
...
class Ava_Woo_Builder_Single_Excerpt extends Ava_Woo_Builder_Base {

	public function get_name() {
		return 'ava-single-excerpt';
	}

	public function get_title() {
		return esc_html__( 'Single Excerpt', 'ava-woo-builder' );
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			'ava-woo-builder/ava-single-excerpt/css-scheme',
			array(
				'excerpt' => '.ava-woo-builder .woocommerce-product-details__short-description'
			)
		);
