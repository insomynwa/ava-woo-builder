<?php
/**
 * Class: Ava_Woo_Builder_Single_Title
 * Name: Single Title
 * Slug: ava-single-title
 */
...
class Ava_Woo_Builder_Single_Title extends Ava_Woo_Builder_Base {

	public function get_name() {
		return 'ava-single-title';
	}

	public function get_title() {
		return esc_html__( 'Single Title', 'ava-woo-builder' );
	}
	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			'ava-woo-builder/ava-single-title/css-scheme',
			array(
				'title' => '.ava-woo-builder .product_title'
			)
		);
