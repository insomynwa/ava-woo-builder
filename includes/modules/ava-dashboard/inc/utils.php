...
/**
 * Define Ava_Dashboard_Utils class
 */
class Utils {
	 ...
	 * @var string
	 */
	public static $api_url = 'https://api.blockcroco.com';
	 ...
	 * @var string
	 */
	public static $license_data_key = 'ava-license-data';
	...
	public static function get_api_url() {
		...
		return apply_filters( 'ava-dashboard/license/api-url', self::$api_url );
	}
