...
abstract class Module {
	...
	public function __construct() {
		...
		add_action(
			'ava-dashboard/before-enqueue-assets/' . $this->get_slug(),
			array( $this, 'assets' )
		);

		add_action( 'wp_ajax_ava_dashboard/' . $this->get_slug(), array( $this, 'process_ajax' ) );
	}
	...
	public function assets() {
		...
		add_filter( 'ava-dashboard/js-page-config', array( $this, 'page_config' ), 10, 2 );
		add_filter( 'ava-dashboard/js-page-templates', array( $this, 'page_templates' ), 10, 2 );
	}
