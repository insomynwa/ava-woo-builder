...
>
	...
	<div class="responce-data-popup__content">
		<div v-if="code === 'limit_exceeded'">
			...
			<p>Also, we provide an upgrade option that will allow you to get all Ava Plugins for unlimited websites. <a href="https://blockcroco.com/pricing/?utm_source=ava-dashboard&utm_medium=activation-limit-exceeded&utm_campaign=update-license-link" target="_blank">Update Now</a></p>
		</div>
	</div>
</div>
