<div class="ava-dashboard-license-page">
	<div class="ready-for-use-plugins cx-vui-panel">
		...
		>
			<div class="cx-vui-subtitle">Your Installed AvaPlugins</div>
	...
	<transition name="popup">
		...
		>
			<div slot="title">
				<div class="cx-vui-popup__header-label">AvaPlugins License Deactivation</div>
			</div>
			<div slot="content">
	...
	<transition name="popup">
		...
		>
			<div slot="title">
				<div class="cx-vui-popup__header-label">AvaPlugin’s Update</div>
			</div>
			<div slot="content">
				...
				<p><span>Ooops!</span>Sorry, but you need to activate license to update your AvaPlugin</p>
				<cx-vui-button
