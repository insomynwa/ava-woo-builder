...
( function( $, dashboardPageConfig ) {
	...
	Vue.component( 'license-item', {
		template: '#ava-dashboard-license-item',
	...
	Vue.component( 'plugin-item-installed', {
		template: '#ava-dashboard-plugin-item-installed',
		...
		methods: {
			...
			pluginAction: function() {
				...
				self.actionPluginRequest = $.ajax( {
					...
					dataType: 'json',
					data: {
						action: 'ava_dashboard_plugin_action',
						data: {
	...
	Vue.component( 'plugin-item-avaliable', {
		template: '#ava-dashboard-plugin-item-avaliable',
	...
	Vue.component( 'plugin-item-more', {
		template: '#ava-dashboard-plugin-item-more',
		...
		computed: {
			demoLink: function() {
				let authorSlug = dashboardPageConfig.themeInfo.authorSlug || 'ava-dashboard';
	...
	Vue.component( 'responce-info', {
		template: '#ava-dashboard-responce-info',
	 ...
	 * @type {String}
	 */
	Vue.component( 'ava-dashboard-header', {
		template: '#ava-dashboard-header',
	 ...
	 * [mounted description]
	 */
	window.AvaDasboardPage = new Vue( {
		el: '#ava-dashboard-page',
...
})( jQuery, window.AvaDashboardPageConfig );
