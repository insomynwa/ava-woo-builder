...
if ( ! class_exists( 'Ava_Woo_Builder_Settings' ) ) {
	...
	class Ava_Woo_Builder_Settings {
		...
		public function saved_notice() {
			...
			$message = esc_html__( 'Settings saved', 'ava-woo-builder' );
		...
		public function register_page() {
			...
			add_submenu_page(
				'elementor',
				esc_html__( 'Ava Woo Builder Settings', 'ava-woo-builder' ),
				esc_html__( 'Ava Woo Builder Settings', 'ava-woo-builder' ),
				'manage_options',
				$this->key,
		...
		public function render_page() {
			...
			$this->builder->register_section(
				array(
					'ava_woo_builder_settings' => array(
						'type'   => 'section',
						'scroll' => false,
						'title'  => esc_html__( 'Ava Woo Builder Settings', 'ava-woo-builder' ),
					),
				)
			);
			...
			$this->builder->register_form(
				array(
					'ava_woo_builder_settings_form' => array(
						'type'   => 'form',
						'parent' => 'ava_woo_builder_settings',
			...
			$this->builder->register_settings(
				array(
					'settings_top' => array(
						'type'   => 'settings',
						'parent' => 'ava_woo_builder_settings_form',
					),
			...
			$this->builder->register_component(
				array(
					'ava_woo_builder_tab_vertical' => array(
			...
			$this->builder->register_settings(
				array(
					'available_widgets_options' => array(
						'parent'      => 'ava_woo_builder_tab_vertical',
						'title'       => esc_html__( 'Available Widgets', 'ava-woo-builder' ),
					),
				)
			);
			...
			$this->builder->register_control(
				array(
					'global_available_widgets' => array(
						...
						'title'       => esc_html__( 'Global Available Widgets', 'ava-woo-builder' ),
						'description' => esc_html__( 'List of widgets that will be available when editing the page', 'ava-woo-builder' ),
						'class'       => 'ava_woo_builder_settings_form__checkbox-group'
					),
				)
			);
			...
			$this->builder->register_control(
				array(
					'single_product_available_widgets' => array(
						...
						'title'       => esc_html__( 'Single Product Available Widgets', 'ava-woo-builder' ),
						'description' => esc_html__( 'List of widgets that will be available when editing the single product template', 'ava-woo-builder' ),
						'class'       => 'ava_woo_builder_settings_form__checkbox-group'
					),
				)
			);
			...
			$this->builder->register_control(
				array(
					'archive_product_available_widgets' => array(
						...
						'title'       => esc_html__( 'Archive Product Available Widgets', 'ava-woo-builder' ),
						'description' => esc_html__( 'List of widgets that will be available when editing the archive product template', 'ava-woo-builder' ),
						'class'       => 'ava_woo_builder_settings_form__checkbox-group'
					),
				)
			);
			...
			$this->builder->register_control(
				array(
					'archive_category_available_widgets' => array(
						...
						'title'       => esc_html__( 'Archive Category Available Widgets', 'ava-woo-builder' ),
						'description' => esc_html__( 'List of widgets that will be available when editing the archive category template', 'ava-woo-builder' ),
						'class'       => 'ava_woo_builder_settings_form__checkbox-group'
					),
				)
			);
			...
			$this->builder->register_control(
				array(
					'shop_product_available_widgets' => array(
						...
						'title'       => esc_html__( 'Shop Product Available Widgets', 'ava-woo-builder' ),
						'description' => esc_html__( 'List of widgets that will be available when editing the archive product template', 'ava-woo-builder' ),
						'class'       => 'ava_woo_builder_settings_form__checkbox-group'
					),
				)
			...
			$this->builder->register_settings(
				array(
					'product_thumb_effect_options' => array(
						'parent' => 'ava_woo_builder_tab_vertical',
						'title'  => esc_html__( 'Product Thumb Effect', 'ava-woo-builder' ),
					),
				)
			);
			...
			$this->builder->register_control(
				array(
					'enable_product_thumb_effect' => array(
						...
						'title'       => esc_html__( 'Enable Thumbnails Effect', 'ava-woo-builder' ),
						'description' => esc_html__( 'Enable thumbnails switch on hover', 'ava-woo-builder' ),
			...
			$this->builder->register_control(
				array(
					'product_thumb_effect' => array(
						...
						'options' => array(
							'slide-left'     => esc_html__( 'Slide Left', 'ava-woo-builder' ),
							'slide-right'    => esc_html__( 'Slide Right', 'ava-woo-builder' ),
							'slide-top'      => esc_html__( 'Slide Top', 'ava-woo-builder' ),
							'slide-bottom'   => esc_html__( 'Slide Bottom', 'ava-woo-builder' ),
							'fade'           => esc_html__( 'Fade', 'ava-woo-builder' ),
							'fade-with-zoom' => esc_html__( 'Fade With Zoom', 'ava-woo-builder' ),
						),
						'title'   => esc_html__( 'Thumbnails Effect:', 'ava-woo-builder' ),
					)
				)
			);
			...
			$this->builder->register_html(
				array(
					'save_button' => array(
						...
						'html'   => '<button type="submit" class="button button-primary">' . esc_html__( 'Save', 'ava-woo-builder' ) . '</button>',
					),
				)
			);

			echo '<div class="ava-woo-builder-settings-page">';
				$this->builder->render();
			echo '</div>';
		}
