...
require ava_woo_builder()->plugin_path( 'includes/updater/class-ava-woo-builder-base-update.php' );
 ...
 * @since 1.0.0
 */
class Ava_Woo_Builder_Plugin_Update extends Ava_Woo_Builder_Base_Update {
...
if ( ! function_exists( 'ava_woo_builder_updater' ) ) {
	function ava_woo_builder_updater() {
		return new Ava_Woo_Builder_Plugin_Update();
	}
}
