 ...
 */
if ( ! class_exists( 'Ava_Woo_Builder_Shortcode_Base' ) ) {

	abstract class Ava_Woo_Builder_Shortcode_Base {
		...
		public function get_template( $name ) {
			return ava_woo_builder()->get_template( $this->get_tag() . '/global/' . $name . '.php' );
		}
