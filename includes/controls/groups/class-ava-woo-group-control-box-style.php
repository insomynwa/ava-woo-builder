...
class Ava_Woo_Group_Control_Box_Style extends Elementor\Group_Control_Base {

	protected static $fields;

	public static function get_type() {
		return 'ava-woo-box-style';
	}
	...
	protected function init_fields() {
		...
		$fields['box_font_color'] = array(
			'label'     => esc_html__( 'Font Color', 'ava-woo-builder' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
		...
		$fields['box_size'] = array(
			'label'      => esc_html__( 'Box Size', 'ava-woo-builder' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => array(
				'px', 'em', '%',
			),
		...
		$fields['box_border'] = array(
			'label'   => _x( 'Border Type', 'Border Control', 'ava-woo-builder' ),
			'type'    => Controls_Manager::SELECT,
			'options' => array(
				''       => esc_html__( 'None', 'ava-woo-builder' ),
				'solid'  => _x( 'Solid', 'Border Control', 'ava-woo-builder' ),
				'double' => _x( 'Double', 'Border Control', 'ava-woo-builder' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'ava-woo-builder' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'ava-woo-builder' ),
			),
			'selectors' => array(
		...
		$fields['box_border_width'] = array(
			'label'     => _x( 'Width', 'Border Control', 'ava-woo-builder' ),
		...
		$fields['box_border_color'] = array(
			'label' => _x( 'Color', 'Border Control', 'ava-woo-builder' ),
			'type' => Controls_Manager::COLOR,
			'default' => '',
			'selectors' => array(
		...
		$fields['allow_box_shadow'] = array(
			'label' => _x( 'Box Shadow', 'Box Shadow Control', 'ava-woo-builder' ),
		...
		$fields['box_shadow_position'] = array(
			'label' => _x( 'Position', 'Box Shadow Control', 'ava-woo-builder' ),
			'type' => Controls_Manager::SELECT,
			'options' => array(
				' '     => _x( 'Outline', 'Box Shadow Control', 'ava-woo-builder' ),
				'inset' => _x( 'Inset', 'Box Shadow Control', 'ava-woo-builder' ),
			),
			'condition' => array(
				'allow_box_shadow!' => '',
			),
