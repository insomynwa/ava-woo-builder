...
class Rest_Api {
	 ...
	 * @var string
	 */
	public $api_namespace = '/ava-woo-builder-api/v1';
	...
	/**
	 * Initialize all AvaEngine related Rest API endpoints
	 *
	...
	public function init_endpoints() {
		...
		do_action( 'ava-woo-builder/rest/init-endpoints', $this );
