...
if ( ! class_exists( 'Ava_Woo_Builder_Tools' ) ) {

	/**
	 * Define Ava_Woo_Builder_Tools class
	 */
	class Ava_Woo_Builder_Tools {
		...
		public function get_theme_icons_data() {
			 ...
			 * @var array
			 */
			$icon_data = apply_filters( 'ava-woo-builder/controls/icon/data', $default );
		...
		public function orderby_arr() {
			return array(
				...
				'ID'            => esc_html__( 'ID', 'ava-woo-builder' ),
				'author'        => esc_html__( 'Author', 'ava-woo-builder' ),
				'title'         => esc_html__( 'Title', 'ava-woo-builder' ),
				'name'          => esc_html__( 'Name (slug)', 'ava-woo-builder' ),
				'date'          => esc_html__( 'Date', 'ava-woo-builder' ),
				'modified'      => esc_html__( 'Modified', 'ava-woo-builder' ),
				'rand'          => esc_html__( 'Rand', 'ava-woo-builder' ),
				'comment_count' => esc_html__( 'Comment Count', 'ava-woo-builder' ),
		...
		public function order_arr() {
			...
			return array(
				'desc' => esc_html__( 'Descending', 'ava-woo-builder' ),
				'asc'  => esc_html__( 'Ascending', 'ava-woo-builder' ),
			);
		...
		public function get_post_types() {
			...
			$deprecated = apply_filters(
				'ava-woo-builder/post-types-list/deprecated',
		...
		public function get_available_prev_arrows_list() {
			return apply_filters(
				...
				array(
					'fa fa-angle-left'          => __( 'Angle', 'ava-woo-builder' ),
					'fa fa-chevron-left'        => __( 'Chevron', 'ava-woo-builder' ),
					'fa fa-angle-double-left'   => __( 'Angle Double', 'ava-woo-builder' ),
					'fa fa-arrow-left'          => __( 'Arrow', 'ava-woo-builder' ),
					'fa fa-caret-left'          => __( 'Caret', 'ava-woo-builder' ),
					'fa fa-long-arrow-left'     => __( 'Long Arrow', 'ava-woo-builder' ),
					'fa fa-arrow-circle-left'   => __( 'Arrow Circle', 'ava-woo-builder' ),
					'fa fa-chevron-circle-left' => __( 'Chevron Circle', 'ava-woo-builder' ),
		...
		public function get_available_next_arrows_list() {
			return apply_filters(
				...
				array(
					'fa fa-angle-right'          => __( 'Angle', 'ava-woo-builder' ),
					'fa fa-chevron-right'        => __( 'Chevron', 'ava-woo-builder' ),
					'fa fa-angle-double-right'   => __( 'Angle Double', 'ava-woo-builder' ),
					'fa fa-arrow-right'          => __( 'Arrow', 'ava-woo-builder' ),
					'fa fa-caret-right'          => __( 'Caret', 'ava-woo-builder' ),
					'fa fa-long-arrow-right'     => __( 'Long Arrow', 'ava-woo-builder' ),
					'fa fa-arrow-circle-right'   => __( 'Arrow Circle', 'ava-woo-builder' ),
					'fa fa-chevron-circle-right' => __( 'Chevron Circle', 'ava-woo-builder' ),
		...
		public function get_available_rating_icons_list() {
			...
			return apply_filters(
				'ava_woo_builder/available_rating_list/icons',
				array(
					'avawoo-front-icon-rating-1'  => __( 'Rating 1', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-2'  => __( 'Rating 2', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-3'  => __( 'Rating 3', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-4'  => __( 'Rating 4', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-5'  => __( 'Rating 5', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-6'  => __( 'Rating 6', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-7'  => __( 'Rating 7', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-8'  => __( 'Rating 8', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-9'  => __( 'Rating 9', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-10' => __( 'Rating 10', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-11' => __( 'Rating 11', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-12' => __( 'Rating 12', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-13' => __( 'Rating 13', 'ava-woo-builder' ),
					'avawoo-front-icon-rating-14' => __( 'Rating 14', 'ava-woo-builder' ),
				)
			);
...
/**
 * Returns instance of Ava_Woo_Builder_Tools
 *
 * @return object
 */
function ava_woo_builder_tools() {
	return Ava_Woo_Builder_Tools::get_instance();
}
