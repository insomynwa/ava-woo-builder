 ...
 */
class Ava_Woo_Products_List_Shortcode extends Ava_Woo_Builder_Shortcode_Base {
	...
	public function get_atts() {
		...
		return apply_filters( 'ava-woo-builder/shortcodes/ava-woo-products-list/atts', array(
			'products_layout' => array(
				'type'    => 'select',
				'label'   => esc_html__( 'Layout', 'ava-woo-builder' ),
				'default' => 'left',
				'options' => array(
					'left'  => esc_html__( 'Image Left', 'ava-woo-builder' ),
					'right' => esc_html__( 'Image Right', 'ava-woo-builder' ),
			...
			'show_image'      => array(
				'type'         => 'switcher',
				'label'        => esc_html__( 'Show Products Featured Image', 'ava-woo-builder' ),
				'label_on'     => esc_html__( 'Yes', 'ava-woo-builder' ),
				'label_off'    => esc_html__( 'No', 'ava-woo-builder' ),
				'return_value' => 'yes',
				'default'      => 'yes',
	...
	public function query() {
		...
		$query_args = apply_filters( 'ava-woo-builder/shortcodes/ava-woo-products-list/query-args', $query_args, $this );
	...
	public function _shortcode( $content = null ) {
		 ...
		 */
		do_action( 'ava-woo-builder/shortcodes/ava-woo-products-list/loop-start' );
		...
		while ( $query->have_posts() ) {
			 ...
			 */
			do_action( 'ava-woo-builder/shortcodes/ava-woo-products-list/loop-item-start' );
			 ...
			 */
			do_action( 'ava-woo-builder/shortcodes/ava-woo-products-list/loop-item-end' );
		 ...
		 */
		do_action( 'ava-woo-builder/shortcodes/ava-woo-products-list/loop-end' );
